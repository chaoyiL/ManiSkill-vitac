...
class VBInputs(transforms.DataTransformFn):
    ...
    def __call__(self, data: dict) -> dict:
        ...
        tactile_left = _parse_image(data["observation.images.tactile_left_0"])
        tactile_right = _parse_image(data["observation.images.tactile_right_0"])

        match self.model_type:
            case _model.ModelType.PI0 | _model.ModelType.PI05:
                names = VIS_IMAGE_KEYS
                images = (wrist_image, tactile_left, tactile_right)
