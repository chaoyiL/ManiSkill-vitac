#!/usr/bin/env bash
#
# 下载 EricChen06 名下的 clean / clean_fix 数据集。
#
# 用法:
#   ./download_all_clean_data.sh [HF dataset cache目录]
#
# 示例:
#   ./download_all_clean_data.sh
#   ./download_all_clean_data.sh ~/.cache/huggingface/dataset
#   HF_DATASET_CACHE_DIR=~/.cache/huggingface/dataset ./download_all_clean_data.sh
#
...
main() {
    ...
    log "============================================"
    log "Hugging Face clean 数据集下载脚本启动"
